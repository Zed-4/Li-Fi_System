...
def condition(response):
    ...
    print("-------------------------------------------------------------------")
def micReady():
    print("Preapering microphone port...")
    command = get_command()
    print("Mic Ready!")
    print("-------------------------------------------------------------------")
def voiceCommand():
...
def hint():
    ...
    labelhint = tk.Label(hint, text = "Valid Commands", fg = "blue", font=("segoe UI", 18)).grid(row=0, column=1)
    labelhint = tk.Label(hint, text = "hello, clear, time", font=("segoe UI", 16)).grid(row=1, column=1)
    labelhint = tk.Label(hint, text = "-------->", font=("segoe UI", 16)).grid(row=1, column=2)
    labelhint = tk.Label(hint, text = "Extra commands", font=("segoe UI", 16)).grid(row=1, column=3)
    labelhint = tk.Label(hint, text = "Description", fg = "blue", font=("segoe UI", 18)).grid(row=0, column=3)
    labelhint = tk.Label(hint, text = "Smoke", font=("segoe UI", 16)).grid(row=2, column=1)
    labelhint = tk.Label(hint, text = "Temperature", font=("segoe UI", 16)).grid(row=3, column=1)
    labelhint = tk.Label(hint, text = "Humidity", font=("segoe UI", 16)).grid(row=4, column=1)
    labelhint = tk.Label(hint, text = "Pressure", font=("segoe UI", 16)).grid(row=5, column=1)
    labelhint = tk.Label(hint, text = "Open", font=("segoe UI", 16)).grid(row=6, column=1)
    labelhint = tk.Label(hint, text = "Close", font=("segoe UI", 16)).grid(row=7, column=1)
    labelhint = tk.Label(hint, text = "-------->", font=("segoe UI", 16)).grid(row=2, column=2)
    labelhint = tk.Label(hint, text = "-------->", font=("segoe UI", 16)).grid(row=3, column=2)
    labelhint = tk.Label(hint, text = "-------->", font=("segoe UI", 16)).grid(row=4, column=2)
    labelhint = tk.Label(hint, text = "-------->", font=("segoe UI", 16)).grid(row=5, column=2)
    labelhint = tk.Label(hint, text = "-------->", font=("segoe UI", 16)).grid(row=6, column=2)
    labelhint = tk.Label(hint, text = "-------->", font=("segoe UI", 16)).grid(row=7, column=2)
    labelhint = tk.Label(hint, text = "Trigger Smoke sensor", font=("segoe UI", 16)).grid(row=2, column=3)
    labelhint = tk.Label(hint, text = "Trigger Temperature sensor", font=("segoe UI", 16)).grid(row=3, column=3)
    labelhint = tk.Label(hint, text = "Trigger humidity sensor", font=("segoe UI", 16)).grid(row=4, column=3)
    labelhint = tk.Label(hint, text = "Trigger pressure sensor", font=("segoe UI", 16)).grid(row=5, column=3)
    labelhint = tk.Label(hint, text = "Open door", font=("segoe UI", 16)).grid(row=6, column=3)
    labelhint = tk.Label(hint, text = "Close door", font=("segoe UI", 16)).grid(row=7, column=3)
    hint.update()
...
labelSmokeSensorValue = tk.Label(window, textvariable = var, fg = "green", font = ("segoe UI", 25)).grid(row=1, column=3)
